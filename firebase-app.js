            ...
            if (IS_MOBILE_UA) {
                ...
                if (!reachable) {
                    ...
                    alert(
                        ...
                        '\n\nاگر باز هم نشد: از منوی مرورگرت (⋮) گزینه «نسخه دسکتاپ / Desktop site» را روشن کن، همین صفحه را با آن حالت باز کن و یک بار لاگین کن — بعضی گوشی‌ها فقط در حالت موبایل با گوگل مشکل دارند. بعد از ورود موفق، Desktop site را دوباره خاموش کن تا به حالت عادی برگردی؛ ورودت ذخیره می‌ماند.'
                    );
                    return;
                }
                try {
                    ...
                    alert(explainAuthError(err) + '\n\nاگر باز هم جواب نداد: از منوی مرورگرت «نسخه دسکتاپ / Desktop site» را فعال کن و همین صفحه را دوباره با آن حالت باز کن — روی این گوشی هنوز در حالت موبایل نمی‌شود با گوگل وارد شد.');
                }
                return;
            }
            try {
